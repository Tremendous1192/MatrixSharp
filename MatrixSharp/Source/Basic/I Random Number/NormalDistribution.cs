...
namespace Tremendous1192.SelfEmployed.MatrixSharp
{
    ...
    /// 正規分布の乱数を生成するクラス.
    /// </summary>
    public class NormalDistribution : IRandomNumber
    {
        uint[] seeds;
        double[] parameters;
        ...
        public NormalDistribution(uint[] setSeeds, double[] setParameters)
        {
            // パラメータの設定
            if (setSeeds != null)
            {
        ...
        retry_point:
            ...
            even = !even;
            return even ? y1 * standardDeviation + average : y2 * standardDeviation + average;
        }
